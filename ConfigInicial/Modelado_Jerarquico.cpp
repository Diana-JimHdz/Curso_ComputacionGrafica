...
*
*Práctica 4: Modelado jerárquico       Fecha de entrega : 6 de septiembre de 2024 
*/
...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Modelado jerarquico: Diana Jimenez", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//Dedo 4 A
		model = glm::translate(modelTemp2, glm::vec3(0.25f, -0.375f, 0.0f));
