...
*
*		      	Práctica 5: Carga de modelos       Fecha de entrega: 13 de septiembre de 2024*/
// Std. Includes
#include <string>
...
int main( )
{
    ...
    GLFWwindow *window = glfwCreateWindow( WIDTH, HEIGHT, "Carga de modelos y camara sintetica- Diana Jimenez", nullptr, nullptr );
