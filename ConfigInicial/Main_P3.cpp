...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Proyecciones y transformaciones basicas - Diana Jiménez Hernández", nullptr, nullptr);
 ...
 //     
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::rotate(model, 45.0f, glm::vec3(15.0f, 0.0f, -15.0f)); 
		...
		model = glm::rotate(model, 45.0f, glm::vec3(0.0f, 0.0f, -51.0f)); // use to compare orthographic and perspective projection
		...
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(-5.0f, -2.0f, -2.0f));
		model = glm::rotate(model, 45.0f, glm::vec3(0.0f, -50.0f, 15.0f)); // use to compare orthographic and perspective projection
		...
		model = glm::mat4(1); 
		model = glm::translate(model, glm::vec3(-10.0f, 2.0f, -4.0f)); 
		model = glm::rotate(model, 45.0f, glm::vec3(-55.0f, -155.0f, 0.0f));  // use to compare orthographic and perspective projection
